...
export function Features() {
  return (
    <section id="features" className="py-24 bg-[#06C755]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-[#06C755] font-bold text-sm uppercase tracking-widest bg-white px-3 py-1 rounded-full">
            Process
          </span>
          <h2 className="mt-6 text-3xl md:text-5xl font-black text-white text-balance">
            Create stickers in minutes
          </h2>
          <p className="mt-4 text-white/90 max-w-lg mx-auto text-lg">
          ...
          {features.map((feature, index) => (
            <div key={feature.step} className="relative group">
              ...
              <div className="flex flex-col items-center text-center">
                {/* Step indicator */}
                <div className="size-16 rounded-2xl bg-white text-[#06C755] text-xl font-bold flex items-center justify-center shadow-sm mb-6 group-hover:scale-110 transition-all duration-300">
                  {feature.icon}
                </div>
                ...
                <span className="mt-4 text-xs font-bold text-white/40 uppercase tracking-wider">Step {feature.step}</span>
              </div>
            </div>
          ))}
        </div>
